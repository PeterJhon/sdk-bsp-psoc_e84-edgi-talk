...
#define CY_CFG_SYSCLK_CLKHF11_DIVIDER CY_SYSCLK_CLKHF_DIVIDE_BY_4
#define CY_CFG_SYSCLK_CLKHF11_FREQ_MHZ 100UL
...
#define CY_CFG_SYSCLK_CLKHF12_CLKPATH CY_SYSCLK_CLKHF_IN_CLKPATH5
...
__STATIC_INLINE void Cy_SysClk_ClkHf11Init(void)
{
    ...
    Cy_SysClk_ClkHfSetDivider(CY_CFG_SYSCLK_CLKHF11, CY_SYSCLK_CLKHF_DIVIDE_BY_4);
    Cy_SysClk_ClkHfEnable(CY_CFG_SYSCLK_CLKHF11);
}
__STATIC_INLINE void Cy_SysClk_ClkHf12Init(void)
{
    Cy_SysClk_ClkHfSetSource(CY_CFG_SYSCLK_CLKHF12, CY_CFG_SYSCLK_CLKHF12_CLKPATH);
    Cy_SysClk_ClkHfSetDivider(CY_CFG_SYSCLK_CLKHF12, CY_SYSCLK_CLKHF_DIVIDE_BY_2);

...
const cyhal_resource_inst_t CYBSP_DEBUG_UART5_CLK_DIV_obj =
{
    .type = CYHAL_RSC_CLOCK,
    .block_num = CYBSP_DEBUG_UART5_CLK_DIV_HW,
    .channel_num = CYBSP_DEBUG_UART5_CLK_DIV_NUM,
};
...
const cyhal_resource_inst_t peri_0_group_8_div_16_0_obj =
{
    .type = CYHAL_RSC_CLOCK,
    .block_num = peri_0_group_8_div_16_0_HW,
    .channel_num = peri_0_group_8_div_16_0_NUM,
};
...
void init_cycfg_clocks(void)
{
    ...
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)CYBSP_DEBUG_UART5_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 0U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_DEBUG_UART5_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 0U, 86U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)CYBSP_DEBUG_UART5_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 0U);
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)CYBSP_SPI_CONTROLLER_10_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 1U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_SPI_CONTROLLER_10_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 1U, 0U);
...
void reserve_cycfg_clocks(void)
{
    ...
    cyhal_hwmgr_reserve(&CYBSP_DEBUG_UART5_CLK_DIV_obj);
    ...
    cyhal_hwmgr_reserve(&peri_0_group_8_div_16_0_obj);

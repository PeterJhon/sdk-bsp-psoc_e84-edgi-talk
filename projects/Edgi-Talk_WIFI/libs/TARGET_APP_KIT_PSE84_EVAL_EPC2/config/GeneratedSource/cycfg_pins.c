...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_ARD_D8_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_ARD_D8_PORT_NUM,
    .channel_num = CYBSP_ARD_D8_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
const cy_stc_gpio_pin_config_t CYBSP_ARD_ADC_0_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_HIGHZ,
    .hsiom = CYBSP_ARD_ADC_0_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_ARD_ADC_0_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_ARD_ADC_0_PORT_NUM,
    .channel_num = CYBSP_ARD_ADC_0_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */

const cy_stc_gpio_pin_config_t CYBSP_ARD_ADC_1_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_STRONG_IN_OFF,
    .hsiom = CYBSP_ARD_ADC_1_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_ARD_ADC_1_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_ARD_ADC_1_PORT_NUM,
    .channel_num = CYBSP_ARD_ADC_1_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_UART5_RX_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_UART5_RX_PORT_NUM,
    .channel_num = CYBSP_UART5_RX_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_UART5_TX_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_UART5_TX_PORT_NUM,
    .channel_num = CYBSP_UART5_TX_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
const cy_stc_gpio_pin_config_t CYBSP_CAPSENSE_XRES_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_STRONG,
    .hsiom = CYBSP_CAPSENSE_XRES_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_CAPSENSE_XRES_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_CAPSENSE_XRES_PORT_NUM,
    .channel_num = CYBSP_CAPSENSE_XRES_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
const cy_stc_gpio_pin_config_t CYBSP_MOTOR_CTL_GPIO_0_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_HIGHZ,
    .hsiom = CYBSP_MOTOR_CTL_GPIO_0_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_MOTOR_CTL_GPIO_0_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_MOTOR_CTL_GPIO_0_PORT_NUM,
    .channel_num = CYBSP_MOTOR_CTL_GPIO_0_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
const cy_stc_gpio_pin_config_t CYBSP_I2C_INT_2_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_STRONG_IN_OFF,
    .hsiom = CYBSP_I2C_INT_2_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_I2C_INT_2_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_I2C_INT_2_PORT_NUM,
    .channel_num = CYBSP_I2C_INT_2_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
const cy_stc_gpio_pin_config_t CYBSP_CH340_OE_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_STRONG,
    .hsiom = CYBSP_CH340_OE_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_CH340_OE_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_CH340_OE_PORT_NUM,
    .channel_num = CYBSP_CH340_OE_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_SERIAL_INT_2_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_SERIAL_INT_2_PORT_NUM,
    .channel_num = CYBSP_SERIAL_INT_2_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_SERIAL_INT_3_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_SERIAL_INT_3_PORT_NUM,
    .channel_num = CYBSP_SERIAL_INT_3_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
void init_cycfg_pins(void)
{
    ...
    Cy_GPIO_Pin_Init(CYBSP_ARD_ADC_0_PORT, CYBSP_ARD_ADC_0_PIN, &CYBSP_ARD_ADC_0_config);
    Cy_GPIO_Pin_Init(CYBSP_ARD_ADC_1_PORT, CYBSP_ARD_ADC_1_PIN, &CYBSP_ARD_ADC_1_config);
    ...
    Cy_GPIO_Pin_Init(CYBSP_CAPSENSE_XRES_PORT, CYBSP_CAPSENSE_XRES_PIN, &CYBSP_CAPSENSE_XRES_config);
    ...
    Cy_GPIO_Pin_Init(CYBSP_MOTOR_CTL_GPIO_0_PORT, CYBSP_MOTOR_CTL_GPIO_0_PIN, &CYBSP_MOTOR_CTL_GPIO_0_config);
    Cy_GPIO_Pin_Init(CYBSP_SW2_PORT, CYBSP_SW2_PIN, &CYBSP_SW2_config);
    Cy_GPIO_Pin_Init(CYBSP_I2C_INT_2_PORT, CYBSP_I2C_INT_2_PIN, &CYBSP_I2C_INT_2_config);
    ...
    Cy_GPIO_Pin_Init(CYBSP_CH340_OE_PORT, CYBSP_CH340_OE_PIN, &CYBSP_CH340_OE_config);
...
void reserve_cycfg_pins(void)
{
    ...
    cyhal_hwmgr_reserve(&CYBSP_ARD_D8_obj);
    cyhal_hwmgr_reserve(&CYBSP_ADC_6_POT_obj);
    cyhal_hwmgr_reserve(&CYBSP_ARD_ADC_0_obj);
    cyhal_hwmgr_reserve(&CYBSP_ARD_ADC_1_obj);
    ...
    cyhal_hwmgr_reserve(&CYBSP_UART5_RX_obj);
    cyhal_hwmgr_reserve(&CYBSP_UART5_TX_obj);
    ...
    cyhal_hwmgr_reserve(&CYBSP_CAPSENSE_XRES_obj);
    ...
    cyhal_hwmgr_reserve(&CYBSP_MOTOR_CTL_GPIO_0_obj);
    cyhal_hwmgr_reserve(&CYBSP_SW2_obj);
    cyhal_hwmgr_reserve(&CYBSP_I2C_INT_2_obj);
    cyhal_hwmgr_reserve(&CYBSP_PDM_CLK_obj);
    cyhal_hwmgr_reserve(&CYBSP_PDM_DATA_obj);
    cyhal_hwmgr_reserve(&CYBSP_CH340_OE_obj);
    cyhal_hwmgr_reserve(&CYBSP_SERIAL_INT_2_obj);
    cyhal_hwmgr_reserve(&CYBSP_SERIAL_INT_3_obj);

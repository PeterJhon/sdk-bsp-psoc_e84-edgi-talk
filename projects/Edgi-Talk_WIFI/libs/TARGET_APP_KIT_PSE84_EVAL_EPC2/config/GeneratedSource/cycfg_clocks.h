...
#define CYBSP_DEBUG_UART5_CLK_DIV_ENABLED 1U

#if defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE)
#define CYBSP_DEBUG_UART5_CLK_DIV_HW CYHAL_CLOCK_BLOCK0_PERIPHERAL1_8BIT
#endif /* defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE) */

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define CYBSP_DEBUG_UART5_CLK_DIV_HW CY_SYSCLK_DIV_8_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define CYBSP_DEBUG_UART5_CLK_DIV_NUM 0U
#define CYBSP_DEBUG_UART5_CLK_DIV_GRP_NUM ((1U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (CYBSP_DEBUG_UART5_CLK_DIV_GRP_NUM)
#define CYBSP_DEBUG_UART5_CLK_DIV_GRP_NUM CYBSP_DEBUG_UART5_CLK_DIV_GRP_NUM
#endif /* !defined (CYBSP_DEBUG_UART5_CLK_DIV_GRP_NUM) */
...
#if defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE)
#define peri_0_group_8_div_16_0_HW CYHAL_CLOCK_BLOCK0_PERIPHERAL8_16BIT
#endif /* defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE) */
...
extern const cyhal_resource_inst_t CYBSP_DEBUG_UART5_CLK_DIV_obj;
...
extern const cyhal_resource_inst_t peri_0_group_8_div_16_0_obj;

...
class OemReqsValidatorPse84A0(DependencyValidator):
    ...
    def validate(self, **_kwargs):
        ...
        mandatory = (
            ...
            self.parser.extended_boot_policy_cm33_rram_app_address,
            self.parser.extended_boot_policy_cm33_rram_app_size,
            ...
            self.parser.extended_boot_policy_external_flash_smif_exflash,

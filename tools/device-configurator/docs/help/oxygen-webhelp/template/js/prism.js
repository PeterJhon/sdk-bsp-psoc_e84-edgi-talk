        ...
        util: {
            ...
            clone: function t(e, r) {
                ...
                case "Array":
                    ...
                    r[n] ? r[n] : (a = [], r[n] = a, e.forEach(function (e, n) {
                            a[n] = t(e, r)
                        }), a);
                default:
                    return e
            ...
            if (M.hooks.run("before-highlight", l), l.grammar)
                if (n && u.Worker) {
                    ...
                    s.onmessage = function (e) {
						var data = document.createElement("innerHTML");
						data.src = e.data;
                        o(data)
                    },
...
Prism.languages.clike = {
    ...
    function : /\b\w+(?=\()/, number: /\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i, operator: /[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/, punctuation: /[{}[\];(),.:]/
};

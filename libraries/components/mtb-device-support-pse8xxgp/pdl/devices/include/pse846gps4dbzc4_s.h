/***************************************************************************//**
* \file pse846gps4dbzc4_s.h
*
* \brief
* PSE846GPS4DBZC4 device header with secure MMIO offsets
*
********************************************************************************
* \copyright
...
#ifndef _PSE846GPS4DBZC4_S_H_
#define _PSE846GPS4DBZC4_S_H_

/**
* \addtogroup group_device PSE846GPS4DBZC4
* \{
*/
...
typedef enum
{
    ...
    smif_0_smif0_interrupt_IRQn       = 102,      /*!< 102 [Active] SMIF Port0 interrupt */
    smif_0_smif1_interrupt_IRQn       = 103,      /*!< 103 [Active] SMIF Port1 interrupt */
    canfd_0_interrupts0_0_IRQn        = 104,      /*!< 104 [Active] CAN #0, Interrupt0, Channel#0 */
    canfd_0_interrupts1_0_IRQn        = 105,      /*!< 105 [Active] CAN #0, Interrupt1, Channel#0 */
    canfd_0_interrupts0_1_IRQn        = 106,      /*!< 106 [Active] CAN #0, Interrupt0, Channel#1 */
    canfd_0_interrupts1_1_IRQn        = 107,      /*!< 107 [Active] CAN #0, Interrupt1, Channel#1 */
    tcpwm_0_interrupts_0_IRQn         = 108,      /*!< 108 [Active] TCPWM, 32-bit Counter #0 */
    tcpwm_0_interrupts_1_IRQn         = 109,      /*!< 109 [Active] TCPWM, 32-bit Counter #1 */
    tcpwm_0_interrupts_2_IRQn         = 110,      /*!< 110 [Active] TCPWM, 32-bit Counter #2 */
    tcpwm_0_interrupts_3_IRQn         = 111,      /*!< 111 [Active] TCPWM, 32-bit Counter #3 */
    tcpwm_0_interrupts_4_IRQn         = 112,      /*!< 112 [Active] TCPWM, 32-bit Counter #4 */
    tcpwm_0_interrupts_5_IRQn         = 113,      /*!< 113 [Active] TCPWM, 32-bit Counter #5 */
    tcpwm_0_interrupts_6_IRQn         = 114,      /*!< 114 [Active] TCPWM, 32-bit Counter #6 */
    tcpwm_0_interrupts_7_IRQn         = 115,      /*!< 115 [Active] TCPWM, 32-bit Counter #7 */
    tcpwm_0_interrupts_256_IRQn       = 116,      /*!< 116 [Active] TCPWM, 16-bit Counter #0 */
    tcpwm_0_interrupts_257_IRQn       = 117,      /*!< 117 [Active] TCPWM, 16-bit Counter #1 */
    tcpwm_0_interrupts_258_IRQn       = 118,      /*!< 118 [Active] TCPWM, 16-bit Counter #2 */
    tcpwm_0_interrupts_259_IRQn       = 119,      /*!< 119 [Active] TCPWM, 16-bit Counter #3 */
    tcpwm_0_interrupts_260_IRQn       = 120,      /*!< 120 [Active] TCPWM, 16-bit Counter #4 */
    tcpwm_0_interrupts_261_IRQn       = 121,      /*!< 121 [Active] TCPWM, 16-bit Counter #5 */
    tcpwm_0_interrupts_262_IRQn       = 122,      /*!< 122 [Active] TCPWM, 16-bit Counter #6 */
    tcpwm_0_interrupts_263_IRQn       = 123,      /*!< 123 [Active] TCPWM, 16-bit Counter #7 */
    tcpwm_0_interrupts_264_IRQn       = 124,      /*!< 124 [Active] TCPWM, 16-bit Counter #8 */
    tcpwm_0_interrupts_265_IRQn       = 125,      /*!< 125 [Active] TCPWM, 16-bit Counter #9 */
    tcpwm_0_interrupts_266_IRQn       = 126,      /*!< 126 [Active] TCPWM, 16-bit Counter #10 */
    tcpwm_0_interrupts_267_IRQn       = 127,      /*!< 127 [Active] TCPWM, 16-bit Counter #11 */
    tcpwm_0_interrupts_268_IRQn       = 128,      /*!< 128 [Active] TCPWM, 16-bit Counter #12 */
    tcpwm_0_interrupts_269_IRQn       = 129,      /*!< 129 [Active] TCPWM, 16-bit Counter #13 */
    tcpwm_0_interrupts_270_IRQn       = 130,      /*!< 130 [Active] TCPWM, 16-bit Counter #14 */
    tcpwm_0_interrupts_271_IRQn       = 131,      /*!< 131 [Active] TCPWM, 16-bit Counter #15 */
    tcpwm_0_interrupts_272_IRQn       = 132,      /*!< 132 [Active] TCPWM, 16-bit Counter #16 */
    tcpwm_0_interrupts_273_IRQn       = 133,      /*!< 133 [Active] TCPWM, 16-bit Counter #17 */
    tcpwm_0_interrupts_274_IRQn       = 134,      /*!< 134 [Active] TCPWM, 16-bit Counter #18 */
    tcpwm_0_interrupts_275_IRQn       = 135,      /*!< 135 [Active] TCPWM, 16-bit Counter #19 */
    tcpwm_0_interrupts_276_IRQn       = 136,      /*!< 136 [Active] TCPWM, 16-bit Counter #20 */
    tcpwm_0_interrupts_277_IRQn       = 137,      /*!< 137 [Active] TCPWM, 16-bit Counter #21 */
    tcpwm_0_interrupts_278_IRQn       = 138,      /*!< 138 [Active] TCPWM, 16-bit Counter #22 */
    tcpwm_0_interrupts_279_IRQn       = 139,      /*!< 139 [Active] TCPWM, 16-bit Counter #23 */
    scb_1_interrupt_IRQn              = 140,      /*!< 140 [Active] SCB#1 Interrupt */
    scb_2_interrupt_IRQn              = 141,      /*!< 141 [Active] SCB#2 Interrupt */
    scb_3_interrupt_IRQn              = 142,      /*!< 142 [Active] SCB#3 Interrupt */
    scb_4_interrupt_IRQn              = 143,      /*!< 143 [Active] SCB#4 Interrupt */
    scb_5_interrupt_IRQn              = 144,      /*!< 144 [Active] SCB#5 Interrupt */
    scb_6_interrupt_IRQn              = 145,      /*!< 145 [Active] SCB#6 Interrupt */
    scb_7_interrupt_IRQn              = 146,      /*!< 146 [Active] SCB#7 Interrupt */
    scb_8_interrupt_IRQn              = 147,      /*!< 147 [Active] SCB#8 Interrupt */
    scb_9_interrupt_IRQn              = 148,      /*!< 148 [Active] SCB#9 Interrupt */
    scb_10_interrupt_IRQn             = 149,      /*!< 149 [Active] SCB#10 Interrupt */
    scb_11_interrupt_IRQn             = 150,      /*!< 150 [Active] SCB#11 Interrupt */
    mxu55_interrupt_npu_IRQn          = 151,      /*!< 151 [Active] Interrupt requests of armu55 (NPU) */
    sdhc_0_interrupt_general_IRQn     = 152,      /*!< 152 [Active] SDHC0 */
    sdhc_0_interrupt_wakeup_IRQn      = 153,      /*!< 153 [Active] SDHC0 */
    sdhc_1_interrupt_general_IRQn     = 154,      /*!< 154 [Active] SDHC1 */
    sdhc_1_interrupt_wakeup_IRQn      = 155,      /*!< 155 [Active] SDHC1 */
    tdm_0_interrupts_rx_0_IRQn        = 156,      /*!< 156 [Active] TDM0 Audio interrupt RX Structure#0 */
    tdm_0_interrupts_tx_0_IRQn        = 157,      /*!< 157 [Active] TDM0 Audio interrupt TX Structure#0 */
    tdm_0_interrupts_rx_1_IRQn        = 158,      /*!< 158 [Active] TDM0 Audio interrupt RX Structure#1 */
    tdm_0_interrupts_tx_1_IRQn        = 159,      /*!< 159 [Active] TDM0 Audio interrupt TX Structure#1 */
    gfxss_interrupt_gpu_IRQn          = 160,      /*!< 160 [Active] Interrupt from GPU. */
    gfxss_interrupt_dc_IRQn           = 161,      /*!< 161 [Active] Interrupt from DC. */
    gfxss_interrupt_mipidsi_IRQn      = 162,      /*!< 162 [Active] Interrupt from MIPIDSI. */
    pdm_0_interrupts_0_IRQn           = 163,      /*!< 163 [Active] PDM interrupt Structure#0 */
    pdm_0_interrupts_1_IRQn           = 164,      /*!< 164 [Active] PDM interrupt Structure#1 */
    pdm_0_interrupts_2_IRQn           = 165,      /*!< 165 [Active] PDM interrupt Structure#2 */
    pdm_0_interrupts_3_IRQn           = 166,      /*!< 166 [Active] PDM interrupt Structure#3 */
    pdm_0_interrupts_4_IRQn           = 167,      /*!< 167 [Active] PDM interrupt Structure#4 */
    pdm_0_interrupts_5_IRQn           = 168,      /*!< 168 [Active] PDM interrupt Structure#5 */
    eth_interrupt_eth_0_IRQn          = 169,      /*!< 169 [Active] ETH Interrupt#0 */
    eth_interrupt_eth_1_IRQn          = 170,      /*!< 170 [Active] ETH Interrupt#1 */
    eth_interrupt_eth_2_IRQn          = 171,      /*!< 171 [Active] ETH Interrupt#2 */
    usbhs_interrupt_usbhsctrl_IRQn    = 172,      /*!< 172 [Active] Interrupt of Controller core */
    usbhs_interrupt_usbhsss_IRQn      = 173,      /*!< 173 [Active] Interrupt of Subsystem */
    i3c_interrupt_IRQn                = 174,      /*!< 174 [Active] I3C Interrupt */
    m33syscpuss_interrupt_msc_IRQn    = 175,      /*!< 175 [Active]  */
    crypto_interrupt_IRQn             = 176,      /*!< 176 [Active] Crypto Interrupt */
    m33syscpuss_interrupts_fault_0_IRQn = 177,    /*!< 177 [Active]  */
    m33syscpuss_interrupts_fault_1_IRQn = 178,    /*!< 178 [Active]  */
    unconnected_IRQn                  = 1023      /*!< 1023 Unconnected */
    ...
    smif_0_smif0_interrupt_IRQn       =  80,      /*!<  80 [Active] SMIF Port0 interrupt */
    smif_0_smif1_interrupt_IRQn       =  81,      /*!<  81 [Active] SMIF Port0 interrupt */
    canfd_0_interrupts0_0_IRQn        =  82,      /*!<  82 [Active] CAN #0, Interrupt0, Channel#0 */
    canfd_0_interrupts1_0_IRQn        =  83,      /*!<  83 [Active] CAN #0, Interrupt1, Channel#0 */
    canfd_0_interrupts0_1_IRQn        =  84,      /*!<  84 [Active] CAN #0, Interrupt0, Channel#1 */
    canfd_0_interrupts1_1_IRQn        =  85,      /*!<  85 [Active] CAN #0, Interrupt1, Channel#1 */
    tcpwm_0_interrupts_0_IRQn         =  86,      /*!<  86 [Active] TCPWM, 32-bit Counter #0 */
    tcpwm_0_interrupts_1_IRQn         =  87,      /*!<  87 [Active] TCPWM, 32-bit Counter #1 */
    tcpwm_0_interrupts_2_IRQn         =  88,      /*!<  88 [Active] TCPWM, 32-bit Counter #2 */
    tcpwm_0_interrupts_3_IRQn         =  89,      /*!<  89 [Active] TCPWM, 32-bit Counter #3 */
    tcpwm_0_interrupts_4_IRQn         =  90,      /*!<  90 [Active] TCPWM, 32-bit Counter #4 */
    tcpwm_0_interrupts_5_IRQn         =  91,      /*!<  91 [Active] TCPWM, 32-bit Counter #5 */
    tcpwm_0_interrupts_6_IRQn         =  92,      /*!<  92 [Active] TCPWM, 32-bit Counter #6 */
    tcpwm_0_interrupts_7_IRQn         =  93,      /*!<  93 [Active] TCPWM, 32-bit Counter #7 */
    tcpwm_0_interrupts_256_IRQn       =  94,      /*!<  94 [Active] TCPWM, 16-bit Counter #0 */
    tcpwm_0_interrupts_257_IRQn       =  95,      /*!<  95 [Active] TCPWM, 16-bit Counter #1 */
    tcpwm_0_interrupts_258_IRQn       =  96,      /*!<  96 [Active] TCPWM, 16-bit Counter #2 */
    tcpwm_0_interrupts_259_IRQn       =  97,      /*!<  97 [Active] TCPWM, 16-bit Counter #3 */
    tcpwm_0_interrupts_260_IRQn       =  98,      /*!<  98 [Active] TCPWM, 16-bit Counter #4 */
    tcpwm_0_interrupts_261_IRQn       =  99,      /*!<  99 [Active] TCPWM, 16-bit Counter #5 */
    tcpwm_0_interrupts_262_IRQn       = 100,      /*!< 100 [Active] TCPWM, 16-bit Counter #6 */
    tcpwm_0_interrupts_263_IRQn       = 101,      /*!< 101 [Active] TCPWM, 16-bit Counter #7 */
    tcpwm_0_interrupts_264_IRQn       = 102,      /*!< 102 [Active] TCPWM, 16-bit Counter #8 */
    tcpwm_0_interrupts_265_IRQn       = 103,      /*!< 103 [Active] TCPWM, 16-bit Counter #9 */
    tcpwm_0_interrupts_266_IRQn       = 104,      /*!< 104 [Active] TCPWM, 16-bit Counter #10 */
    tcpwm_0_interrupts_267_IRQn       = 105,      /*!< 105 [Active] TCPWM, 16-bit Counter #11 */
    tcpwm_0_interrupts_268_IRQn       = 106,      /*!< 106 [Active] TCPWM, 16-bit Counter #12 */
    tcpwm_0_interrupts_269_IRQn       = 107,      /*!< 107 [Active] TCPWM, 16-bit Counter #13 */
    tcpwm_0_interrupts_270_IRQn       = 108,      /*!< 108 [Active] TCPWM, 16-bit Counter #14 */
    tcpwm_0_interrupts_271_IRQn       = 109,      /*!< 109 [Active] TCPWM, 16-bit Counter #15 */
    tcpwm_0_interrupts_272_IRQn       = 110,      /*!< 110 [Active] TCPWM, 16-bit Counter #16 */
    tcpwm_0_interrupts_273_IRQn       = 111,      /*!< 111 [Active] TCPWM, 16-bit Counter #17 */
    tcpwm_0_interrupts_274_IRQn       = 112,      /*!< 112 [Active] TCPWM, 16-bit Counter #18 */
    tcpwm_0_interrupts_275_IRQn       = 113,      /*!< 113 [Active] TCPWM, 16-bit Counter #19 */
    tcpwm_0_interrupts_276_IRQn       = 114,      /*!< 114 [Active] TCPWM, 16-bit Counter #20 */
    tcpwm_0_interrupts_277_IRQn       = 115,      /*!< 115 [Active] TCPWM, 16-bit Counter #21 */
    tcpwm_0_interrupts_278_IRQn       = 116,      /*!< 116 [Active] TCPWM, 16-bit Counter #22 */
    tcpwm_0_interrupts_279_IRQn       = 117,      /*!< 117 [Active] TCPWM, 16-bit Counter #23 */
    scb_1_interrupt_IRQn              = 118,      /*!< 118 [Active] SCB#1 Interrupt */
    scb_2_interrupt_IRQn              = 119,      /*!< 119 [Active] SCB#2 Interrupt */
    scb_3_interrupt_IRQn              = 120,      /*!< 120 [Active] SCB#3 Interrupt */
    scb_4_interrupt_IRQn              = 121,      /*!< 121 [Active] SCB#4 Interrupt */
    scb_5_interrupt_IRQn              = 122,      /*!< 122 [Active] SCB#5 Interrupt */
    scb_6_interrupt_IRQn              = 123,      /*!< 123 [Active] SCB#6 Interrupt */
    scb_7_interrupt_IRQn              = 124,      /*!< 124 [Active] SCB#7 Interrupt */
    scb_8_interrupt_IRQn              = 125,      /*!< 125 [Active] SCB#8 Interrupt */
    scb_9_interrupt_IRQn              = 126,      /*!< 126 [Active] SCB#9 Interrupt */
    scb_10_interrupt_IRQn             = 127,      /*!< 127 [Active] SCB#10 Interrupt */
    scb_11_interrupt_IRQn             = 128,      /*!< 128 [Active] SCB#11 Interrupt */
    sdhc_0_interrupt_general_IRQn     = 129,      /*!< 129 [Active] SDHC0 */
    sdhc_0_interrupt_wakeup_IRQn      = 130,      /*!< 130 [Active] SDHC0 */
    sdhc_1_interrupt_general_IRQn     = 131,      /*!< 131 [Active] SDHC1 */
    sdhc_1_interrupt_wakeup_IRQn      = 132,      /*!< 132 [Active] SDHC1 */
    tdm_0_interrupts_rx_0_IRQn        = 133,      /*!< 133 [Active] TDM0 Audio interrupt RX Structure#0 */
    tdm_0_interrupts_tx_0_IRQn        = 134,      /*!< 134 [Active] TDM0 Audio interrupt TX Structure#0 */
    tdm_0_interrupts_rx_1_IRQn        = 135,      /*!< 135 [Active] TDM0 Audio interrupt RX Structure#1 */
    tdm_0_interrupts_tx_1_IRQn        = 136,      /*!< 136 [Active] TDM0 Audio interrupt TX Structure#1 */
    gfxss_interrupt_gpu_IRQn          = 137,      /*!< 137 [Active] Interrupt from GPU. */
    gfxss_interrupt_dc_IRQn           = 138,      /*!< 138 [Active] Interrupt from DC. */
    gfxss_interrupt_mipidsi_IRQn      = 139,      /*!< 139 [Active] Interrupt from MIPIDSI. */
    pdm_0_interrupts_0_IRQn           = 140,      /*!< 140 [Active] PDM interrupt Structure#0 */
    pdm_0_interrupts_1_IRQn           = 141,      /*!< 141 [Active] PDM interrupt Structure#1 */
    pdm_0_interrupts_2_IRQn           = 142,      /*!< 142 [Active] PDM interrupt Structure#2 */
    pdm_0_interrupts_3_IRQn           = 143,      /*!< 143 [Active] PDM interrupt Structure#3 */
    pdm_0_interrupts_4_IRQn           = 144,      /*!< 144 [Active] PDM interrupt Structure#4 */
    pdm_0_interrupts_5_IRQn           = 145,      /*!< 145 [Active] PDM interrupt Structure#5 */
    eth_interrupt_eth_0_IRQn          = 146,      /*!< 146 [Active] ETH Interrupt#0 */
    eth_interrupt_eth_1_IRQn          = 147,      /*!< 147 [Active] ETH Interrupt#1 */
    eth_interrupt_eth_2_IRQn          = 148,      /*!< 148 [Active] ETH Interrupt#2 */
    usbhs_interrupt_usbhsctrl_IRQn    = 149,      /*!< 149 [Active] Interrupt of Controller core */
    usbhs_interrupt_usbhsss_IRQn      = 150,      /*!< 150 [Active] Interrupt of Subsystem */
    i3c_interrupt_IRQn                = 151,      /*!< 151 [Active] I3C Interrupt */
    crypto_interrupt_IRQn             = 152,      /*!< 152 [Active] Crypto Interrupt */
    m33syscpuss_interrupts_fault_0_IRQn = 153,    /*!< 153 [Active]  */
    m33syscpuss_interrupts_fault_1_IRQn = 154,    /*!< 154 [Active]  */
    m55appcpuss_interrupt_ahb2axi_buff_err_IRQn = 155, /*!< 155 [Active] Interrupt from xhb500 ahb to axi bridge */
    unconnected_IRQn                  = 1023      /*!< 1023 Unconnected */
#endif
} IRQn_Type;
...
#define CY_IP_MXTTCANFD_VERSION_MINOR   1u
...
#define CY_IP_MXDEBUG600_VERSION_MINOR  0u
...
#define CY_IP_MXI3C_VERSION_MINOR       0u
...
#define CY_IP_M0SECCPUSS_VERSION        1u
...
#define CY_IP_MXNNLITE_VERSION          1u
...
#define CY_IP_MXSMIF_VERSION            5u
...
#define CY_IP_MXS22SRSS_VERSION_MINOR   0u
...
#define MS_CTL_2_0_BASE                         0x52294000UL
#define MS_CTL_2_0                              ((MS_CTL_2_0_Type*) MS_CTL_2_0_BASE)                              /* 0x52294000 */
#define MS0                                     ((MS_Type*) &MS_CTL_2_0->MS[0])                                   /* 0x52294000 */
#define MS4                                     ((MS_Type*) &MS_CTL_2_0->MS[4])                                   /* 0x52294040 */
#define MS6                                     ((MS_Type*) &MS_CTL_2_0->MS[6])                                   /* 0x52294060 */
#define MS7                                     ((MS_Type*) &MS_CTL_2_0->MS[7])                                   /* 0x52294070 */
#define MS8                                     ((MS_Type*) &MS_CTL_2_0->MS[8])                                   /* 0x52294080 */
#define MS9                                     ((MS_Type*) &MS_CTL_2_0->MS[9])                                   /* 0x52294090 */
#define MS11                                    ((MS_Type*) &MS_CTL_2_0->MS[11])                                  /* 0x522940B0 */
#define MS29                                    ((MS_Type*) &MS_CTL_2_0->MS[29])                                  /* 0x522941D0 */
#define MS31                                    ((MS_Type*) &MS_CTL_2_0->MS[31])                                  /* 0x522941F0 */
#define MS_PC0                                  ((MS_PC_Type*) &MS_CTL_2_0->MS_PC[0])                             /* 0x52295000 */
#define MS_PC4                                  ((MS_PC_Type*) &MS_CTL_2_0->MS_PC[4])                             /* 0x52295040 */
#define MS_PC6                                  ((MS_PC_Type*) &MS_CTL_2_0->MS_PC[6])                             /* 0x52295060 */
#define MS_PC7                                  ((MS_PC_Type*) &MS_CTL_2_0->MS_PC[7])                             /* 0x52295070 */
#define MS_PC8                                  ((MS_PC_Type*) &MS_CTL_2_0->MS_PC[8])                             /* 0x52295080 */
#define MS_PC9                                  ((MS_PC_Type*) &MS_CTL_2_0->MS_PC[9])                             /* 0x52295090 */
#define MS_PC11                                 ((MS_PC_Type*) &MS_CTL_2_0->MS_PC[11])                            /* 0x522950B0 */
#define MS_PC29                                 ((MS_PC_Type*) &MS_CTL_2_0->MS_PC[29])                            /* 0x522951D0 */
#define MS_PC31                                 ((MS_PC_Type*) &MS_CTL_2_0->MS_PC[31])                            /* 0x522951F0 */
...
#define MXNNLITE_1_0_BASE                       0x52D80000UL
#define MXNNLITE_1_0                            ((MXNNLITE_1_0_Type*) MXNNLITE_1_0_BASE)                          /* 0x52D80000 */
...
#define SMIF0_BASE                              0x54400000UL
#define SMIF0                                   ((SMIF_STRUCT_Type*) SMIF0_BASE)                                  /* 0x54400000 */
#define SMIF0_SMIF_BRIDGE                       ((SMIF_SMIF_BRIDGE_Type*) &SMIF0->SMIF_BRIDGE)                    /* 0x54400000 */
#define SMIF0_SMIF_BRIDGE_SMIF_REMAP_REGION0    ((SMIF_SMIF_BRIDGE_SMIF_REMAP_REGION_Type*) &SMIF0->SMIF_BRIDGE.SMIF_REMAP_REGION[0]) /* 0x54401000 */
#define SMIF0_SMIF_BRIDGE_SMIF_REMAP_REGION1    ((SMIF_SMIF_BRIDGE_SMIF_REMAP_REGION_Type*) &SMIF0->SMIF_BRIDGE.SMIF_REMAP_REGION[1]) /* 0x54401100 */
#define SMIF0_SMIF_BRIDGE_SMIF_REMAP_REGION2    ((SMIF_SMIF_BRIDGE_SMIF_REMAP_REGION_Type*) &SMIF0->SMIF_BRIDGE.SMIF_REMAP_REGION[2]) /* 0x54401200 */
#define SMIF0_SMIF_BRIDGE_SMIF_REMAP_REGION3    ((SMIF_SMIF_BRIDGE_SMIF_REMAP_REGION_Type*) &SMIF0->SMIF_BRIDGE.SMIF_REMAP_REGION[3]) /* 0x54401300 */
#define SMIF0_SMIF_BRIDGE_SMIF_REMAP_REGION4    ((SMIF_SMIF_BRIDGE_SMIF_REMAP_REGION_Type*) &SMIF0->SMIF_BRIDGE.SMIF_REMAP_REGION[4]) /* 0x54401400 */
#define SMIF0_SMIF_BRIDGE_SMIF_REMAP_REGION5    ((SMIF_SMIF_BRIDGE_SMIF_REMAP_REGION_Type*) &SMIF0->SMIF_BRIDGE.SMIF_REMAP_REGION[5]) /* 0x54401500 */
#define SMIF0_SMIF_BRIDGE_SMIF_REMAP_REGION6    ((SMIF_SMIF_BRIDGE_SMIF_REMAP_REGION_Type*) &SMIF0->SMIF_BRIDGE.SMIF_REMAP_REGION[6]) /* 0x54401600 */
#define SMIF0_SMIF_BRIDGE_SMIF_REMAP_REGION7    ((SMIF_SMIF_BRIDGE_SMIF_REMAP_REGION_Type*) &SMIF0->SMIF_BRIDGE.SMIF_REMAP_REGION[7]) /* 0x54401700 */
#define SMIF0_CORE0                             ((SMIF_CORE_Type*) &SMIF0->CORE[0])                               /* 0x54420000 */
#define SMIF0_CORE1                             ((SMIF_CORE_Type*) &SMIF0->CORE[1])                               /* 0x54440000 */
#define SMIF0_CORE0_SMIF_CRYPTO0                ((SMIF_CORE_SMIF_CRYPTO_Type*) &SMIF0->CORE[0].SMIF_CRYPTO_BLOCK[0]) /* 0x54420200 */
#define SMIF0_CORE0_SMIF_CRYPTO1                ((SMIF_CORE_SMIF_CRYPTO_Type*) &SMIF0->CORE[0].SMIF_CRYPTO_BLOCK[1]) /* 0x54420280 */
#define SMIF0_CORE0_SMIF_CRYPTO2                ((SMIF_CORE_SMIF_CRYPTO_Type*) &SMIF0->CORE[0].SMIF_CRYPTO_BLOCK[2]) /* 0x54420300 */
#define SMIF0_CORE0_SMIF_CRYPTO3                ((SMIF_CORE_SMIF_CRYPTO_Type*) &SMIF0->CORE[0].SMIF_CRYPTO_BLOCK[3]) /* 0x54420380 */
#define SMIF0_CORE1_SMIF_CRYPTO0                ((SMIF_CORE_SMIF_CRYPTO_Type*) &SMIF0->CORE[1].SMIF_CRYPTO_BLOCK[0]) /* 0x54440200 */
#define SMIF0_CORE1_SMIF_CRYPTO1                ((SMIF_CORE_SMIF_CRYPTO_Type*) &SMIF0->CORE[1].SMIF_CRYPTO_BLOCK[1]) /* 0x54440280 */
#define SMIF0_CORE1_SMIF_CRYPTO2                ((SMIF_CORE_SMIF_CRYPTO_Type*) &SMIF0->CORE[1].SMIF_CRYPTO_BLOCK[2]) /* 0x54440300 */
#define SMIF0_CORE1_SMIF_CRYPTO3                ((SMIF_CORE_SMIF_CRYPTO_Type*) &SMIF0->CORE[1].SMIF_CRYPTO_BLOCK[3]) /* 0x54440380 */
#define SMIF0_CORE0_DEVICE0                     ((SMIF_CORE_DEVICE_Type*) &SMIF0->CORE[0].DEVICE[0])              /* 0x54420800 */
#define SMIF0_CORE0_DEVICE1                     ((SMIF_CORE_DEVICE_Type*) &SMIF0->CORE[0].DEVICE[1])              /* 0x54420880 */
#define SMIF0_CORE0_DEVICE2                     ((SMIF_CORE_DEVICE_Type*) &SMIF0->CORE[0].DEVICE[2])              /* 0x54420900 */
#define SMIF0_CORE0_DEVICE3                     ((SMIF_CORE_DEVICE_Type*) &SMIF0->CORE[0].DEVICE[3])              /* 0x54420980 */
#define SMIF0_CORE1_DEVICE0                     ((SMIF_CORE_DEVICE_Type*) &SMIF0->CORE[1].DEVICE[0])              /* 0x54440800 */
#define SMIF0_CORE1_DEVICE1                     ((SMIF_CORE_DEVICE_Type*) &SMIF0->CORE[1].DEVICE[1])              /* 0x54440880 */
#define SMIF0_CORE1_DEVICE2                     ((SMIF_CORE_DEVICE_Type*) &SMIF0->CORE[1].DEVICE[2])              /* 0x54440900 */
#define SMIF0_CORE1_DEVICE3                     ((SMIF_CORE_DEVICE_Type*) &SMIF0->CORE[1].DEVICE[3])              /* 0x54440980 */
#define SMIF0_CORE0_SLOW_AHB                    ((SMIF_CORE_SLOW_AHB_Type*) &SMIF0->CORE[0].SLOW_AHB)             /* 0x54421000 */
#define SMIF0_CORE1_SLOW_AHB                    ((SMIF_CORE_SLOW_AHB_Type*) &SMIF0->CORE[1].SLOW_AHB)             /* 0x54441000 */
#define SMIF0_CORE0_SLOW_AHB_MPC0               ((SMIF_CORE_SLOW_AHB_MPC_Type*) &SMIF0->CORE[0].SLOW_AHB.MPC[0])  /* 0x54421000 */
#define SMIF0_CORE1_SLOW_AHB_MPC0               ((SMIF_CORE_SLOW_AHB_MPC_Type*) &SMIF0->CORE[1].SLOW_AHB.MPC[0])  /* 0x54441000 */
#define SMIF0_CORE0_AXI                         ((SMIF_CORE_AXI_Type*) &SMIF0->CORE[0].AXI)                       /* 0x54423000 */
#define SMIF0_CORE1_AXI                         ((SMIF_CORE_AXI_Type*) &SMIF0->CORE[1].AXI)                       /* 0x54443000 */
#define SMIF0_CORE0_AXI_MPC0                    ((SMIF_CORE_AXI_MPC_Type*) &SMIF0->CORE[0].AXI.MPC[0])            /* 0x54423000 */
#define SMIF0_CORE1_AXI_MPC0                    ((SMIF_CORE_AXI_MPC_Type*) &SMIF0->CORE[1].AXI.MPC[0])            /* 0x54443000 */
#define SMIF0_CORE0_SMIF_HSIOM                  ((SMIF_CORE_SMIF_HSIOM_Type*) &SMIF0->CORE[0].SMIF_HSIOM)         /* 0x54424000 */
#define SMIF0_CORE1_SMIF_HSIOM                  ((SMIF_CORE_SMIF_HSIOM_Type*) &SMIF0->CORE[1].SMIF_HSIOM)         /* 0x54444000 */
#define SMIF0_CORE0_SMIF_HSIOM_SMIF_PRT0        ((SMIF_CORE_SMIF_HSIOM_SMIF_PRT_Type*) &SMIF0->CORE[0].SMIF_HSIOM.SMIF_PRT[0]) /* 0x54424000 */
#define SMIF0_CORE0_SMIF_HSIOM_SMIF_PRT1        ((SMIF_CORE_SMIF_HSIOM_SMIF_PRT_Type*) &SMIF0->CORE[0].SMIF_HSIOM.SMIF_PRT[1]) /* 0x54424010 */
#define SMIF0_CORE0_SMIF_HSIOM_SMIF_PRT2        ((SMIF_CORE_SMIF_HSIOM_SMIF_PRT_Type*) &SMIF0->CORE[0].SMIF_HSIOM.SMIF_PRT[2]) /* 0x54424020 */
#define SMIF0_CORE1_SMIF_HSIOM_SMIF_PRT0        ((SMIF_CORE_SMIF_HSIOM_SMIF_PRT_Type*) &SMIF0->CORE[1].SMIF_HSIOM.SMIF_PRT[0]) /* 0x54444000 */
#define SMIF0_CORE1_SMIF_HSIOM_SMIF_PRT1        ((SMIF_CORE_SMIF_HSIOM_SMIF_PRT_Type*) &SMIF0->CORE[1].SMIF_HSIOM.SMIF_PRT[1]) /* 0x54444010 */
#define SMIF0_CORE1_SMIF_HSIOM_SMIF_PRT2        ((SMIF_CORE_SMIF_HSIOM_SMIF_PRT_Type*) &SMIF0->CORE[1].SMIF_HSIOM.SMIF_PRT[2]) /* 0x54444020 */
#define SMIF0_CORE0_SMIF_HSIOM_SMIF_SECURE_PRT0 ((SMIF_CORE_SMIF_HSIOM_SMIF_SECURE_PRT_Type*) &SMIF0->CORE[0].SMIF_HSIOM.SMIF_SECURE_PRT[0]) /* 0x54425000 */
#define SMIF0_CORE0_SMIF_HSIOM_SMIF_SECURE_PRT1 ((SMIF_CORE_SMIF_HSIOM_SMIF_SECURE_PRT_Type*) &SMIF0->CORE[0].SMIF_HSIOM.SMIF_SECURE_PRT[1]) /* 0x54425010 */
#define SMIF0_CORE0_SMIF_HSIOM_SMIF_SECURE_PRT2 ((SMIF_CORE_SMIF_HSIOM_SMIF_SECURE_PRT_Type*) &SMIF0->CORE[0].SMIF_HSIOM.SMIF_SECURE_PRT[2]) /* 0x54425020 */
#define SMIF0_CORE1_SMIF_HSIOM_SMIF_SECURE_PRT0 ((SMIF_CORE_SMIF_HSIOM_SMIF_SECURE_PRT_Type*) &SMIF0->CORE[1].SMIF_HSIOM.SMIF_SECURE_PRT[0]) /* 0x54445000 */
#define SMIF0_CORE1_SMIF_HSIOM_SMIF_SECURE_PRT1 ((SMIF_CORE_SMIF_HSIOM_SMIF_SECURE_PRT_Type*) &SMIF0->CORE[1].SMIF_HSIOM.SMIF_SECURE_PRT[1]) /* 0x54445010 */
#define SMIF0_CORE1_SMIF_HSIOM_SMIF_SECURE_PRT2 ((SMIF_CORE_SMIF_HSIOM_SMIF_SECURE_PRT_Type*) &SMIF0->CORE[1].SMIF_HSIOM.SMIF_SECURE_PRT[2]) /* 0x54445020 */
#define SMIF0_CORE0_SMIF_GPIO                   ((SMIF_CORE_SMIF_GPIO_Type*) &SMIF0->CORE[0].SMIF_GPIO)           /* 0x54430000 */
#define SMIF0_CORE1_SMIF_GPIO                   ((SMIF_CORE_SMIF_GPIO_Type*) &SMIF0->CORE[1].SMIF_GPIO)           /* 0x54450000 */
#define SMIF0_CORE0_SMIF_GPIO_SMIF_PRT0         ((SMIF_CORE_SMIF_GPIO_SMIF_PRT_Type*) &SMIF0->CORE[0].SMIF_GPIO.SMIF_PRT[0]) /* 0x54430000 */
#define SMIF0_CORE0_SMIF_GPIO_SMIF_PRT1         ((SMIF_CORE_SMIF_GPIO_SMIF_PRT_Type*) &SMIF0->CORE[0].SMIF_GPIO.SMIF_PRT[1]) /* 0x54430080 */
#define SMIF0_CORE0_SMIF_GPIO_SMIF_PRT2         ((SMIF_CORE_SMIF_GPIO_SMIF_PRT_Type*) &SMIF0->CORE[0].SMIF_GPIO.SMIF_PRT[2]) /* 0x54430100 */
#define SMIF0_CORE1_SMIF_GPIO_SMIF_PRT0         ((SMIF_CORE_SMIF_GPIO_SMIF_PRT_Type*) &SMIF0->CORE[1].SMIF_GPIO.SMIF_PRT[0]) /* 0x54450000 */
#define SMIF0_CORE1_SMIF_GPIO_SMIF_PRT1         ((SMIF_CORE_SMIF_GPIO_SMIF_PRT_Type*) &SMIF0->CORE[1].SMIF_GPIO.SMIF_PRT[1]) /* 0x54450080 */
#define SMIF0_CORE1_SMIF_GPIO_SMIF_PRT2         ((SMIF_CORE_SMIF_GPIO_SMIF_PRT_Type*) &SMIF0->CORE[1].SMIF_GPIO.SMIF_PRT[2]) /* 0x54450100 */

/*******************************************************************************
*                                     TDM
*******************************************************************************/

#define TDM0_BASE                               0x54480000UL
#define TDM0                                    ((TDM_Type*) TDM0_BASE)                                           /* 0x54480000 */
#define TDM0_TDM_STRUCT0                        ((TDM_TDM_STRUCT_Type*) &TDM0->TDM_STRUCT[0])                     /* 0x54488000 */
#define TDM0_TDM_STRUCT1                        ((TDM_TDM_STRUCT_Type*) &TDM0->TDM_STRUCT[1])                     /* 0x54488200 */
#define TDM0_TDM_STRUCT0_TDM_TX_STRUCT          ((TDM_TDM_STRUCT_TDM_TX_STRUCT_Type*) &TDM0->TDM_STRUCT[0].TDM_TX_STRUCT) /* 0x54488000 */
#define TDM0_TDM_STRUCT1_TDM_TX_STRUCT          ((TDM_TDM_STRUCT_TDM_TX_STRUCT_Type*) &TDM0->TDM_STRUCT[1].TDM_TX_STRUCT) /* 0x54488200 */
#define TDM0_TDM_STRUCT0_TDM_RX_STRUCT          ((TDM_TDM_STRUCT_TDM_RX_STRUCT_Type*) &TDM0->TDM_STRUCT[0].TDM_RX_STRUCT) /* 0x54488100 */
#define TDM0_TDM_STRUCT1_TDM_RX_STRUCT          ((TDM_TDM_STRUCT_TDM_RX_STRUCT_Type*) &TDM0->TDM_STRUCT[1].TDM_RX_STRUCT) /* 0x54488300 */

/*******************************************************************************
*                                     PDM
*******************************************************************************/

#define PDM0_BASE                               0x54490000UL
#define PDM0                                    ((PDM_Type*) PDM0_BASE)                                           /* 0x54490000 */
#define PDM0_CH0                                ((PDM_CH_Type*) &PDM0->CH[0])                                     /* 0x54498000 */
#define PDM0_CH1                                ((PDM_CH_Type*) &PDM0->CH[1])                                     /* 0x54498100 */
#define PDM0_CH2                                ((PDM_CH_Type*) &PDM0->CH[2])                                     /* 0x54498200 */
#define PDM0_CH3                                ((PDM_CH_Type*) &PDM0->CH[3])                                     /* 0x54498300 */
#define PDM0_CH4                                ((PDM_CH_Type*) &PDM0->CH[4])                                     /* 0x54498400 */
#define PDM0_CH5                                ((PDM_CH_Type*) &PDM0->CH[5])                                     /* 0x54498500 */

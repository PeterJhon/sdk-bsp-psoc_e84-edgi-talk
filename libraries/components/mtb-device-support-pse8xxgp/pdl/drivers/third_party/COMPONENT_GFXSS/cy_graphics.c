...
cy_en_gfx_status_t Cy_GFXSS_Transfer_Frame(GFXSS_Type *base, cy_stc_gfx_context_t *context)
{
    ...
    uint32_t No_of_lines = 0, j = 0, line_stride = 0, line_stride_overlay = 0, line_stride_overlay1 = 0;
    ...
    divider < 3 ? divider = 3 : divider;       /* minimum valu for divider is 3*/
    ...
    for (int i = 0; i < vertical_resolution - No_of_lines; i += No_of_lines)
    {

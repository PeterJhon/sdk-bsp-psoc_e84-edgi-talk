...
//          CPS_UncachedRead32(CEDI_RegAddr(int_mask)));
    ...
    for (qNum = CEDI_PdVar(numQs) - 1; qNum < CEDI_MAX_TX_QUEUES; qNum--)
    {
        ...
        default: /* default */
        case 0:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_status));
            break;
        case 1:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q1_status));
            break;
        case 2:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q2_status));
            break;
        case 3:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q3_status));
            break;
        case 4:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q4_status));
            break;
        case 5:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q5_status));
            break;
        case 6:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q6_status));
            break;
        case 7:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q7_status));
            break;
        case 8:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q8_status));
            break;
        case 9:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q9_status));
            break;
        case 10:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q10_status));
            break;
        case 11:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q11_status));
            break;
        case 12:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q12_status));
            break;
        case 13:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q13_status));
            break;
        case 14:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q14_status));
            break;
        case 15:
            isrReg = CPS_UncachedRead32(CEDI_RegAddr(int_q15_status));
            break;
        }
        ...
        if (isrReg)
        {
            ...
            if (0 == CEDI_PdVar(hwCfg).irq_read_clear)
            {
                ...
                default: /* default */
                case 0:
                    CPS_UncachedWrite32(CEDI_RegAddr(int_status), isrReg);
                    break;
            ...
            if (cond1 || cond2 || cond3)
            {
                ...
                default: /* default */
                case 0:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q_ptr));
                    break;
                case 1:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q1_ptr));
                    break;
                case 2:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q2_ptr));
                    break;
                case 3:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q3_ptr));
                    break;
                case 4:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q4_ptr));
                    break;
                case 5:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q5_ptr));
                    break;
                case 6:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q6_ptr));
                    break;
                case 7:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q7_ptr));
                    break;
                case 8:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q8_ptr));
                    break;
                case 9:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q9_ptr));
                    break;
                case 10:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q10_ptr));
                    break;
                case 11:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q11_ptr));
                    break;
                case 12:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q12_ptr));
                    break;
                case 13:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q13_ptr));
                    break;
                case 14:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q14_ptr));
                    break;
                case 15:
                    regVal = CPS_UncachedRead32(CEDI_RegAddr(transmit_q15_ptr));
                    break;
                }
...
uint32_t emacGetLoopback(void *pD, uint8_t *mode)
{
    ...
    else if (EMAC_REGS__NETWORK_CONTROL__LOOPBACK_LOCAL__READ(reg))
        *mode = CEDI_LOCAL_LOOPBACK;
    else

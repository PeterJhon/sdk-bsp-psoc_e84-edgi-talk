...
* permissions. This is called by ROT (Root of Trust) module.
*
*
* \param base
* Base address of mpc being configured
...
* permissions. This is called by Trusted Firmware-M (TF-M) module.
*
*
* \param base
* Base address of mpc being configured
*
* \param config
* MPC configuration structure to be used by the TF-M code
*
* \return
* Initialization status
*
...
****************************************************************************//**
*
* \brief Locks the MPC configuration for ROT (Root of Trust)
*
*
* \param base
* Base address of mpc being configured
